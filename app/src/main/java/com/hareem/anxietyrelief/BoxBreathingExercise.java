...
public class BoxBreathingExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_box_breathing_exercise);
        ...
        SharedPreferences sharedPreferences = this.getSharedPreferences("BoxBreathingCounter", Context.MODE_PRIVATE);
        int counterValue = sharedPreferences.getInt("BoxBreathingCounterValue", 2);
                                ...
                                new CountDownTimer(4000, 1000) {
                                    ...
                                    public void onFinish() {
                                        ...
                                        if (remainingCycles > 1) {
                                            // Run the next box breathing cycle
    ...
    private void handleBreathingCyclesCompleted() {
        ...
        replayCardView.setCardBackgroundColor(ContextCompat.getColor(BoxBreathingExercise.this, R.color.mint_blue_green));
