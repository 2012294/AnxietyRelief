...
public class FourSevenEightExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_four_seven_eight_exercise);
        ...
        SharedPreferences sharedPreferences = this.getSharedPreferences("FourSevenEightBreathingCounter", Context.MODE_PRIVATE);
        int counterValue = sharedPreferences.getInt("FourSevenEightBreathingCounterValue", 2);
                        ...
                        new CountDownTimer(8000, 1000) {
                            ...
                            public void onFinish() {
                                ...
                                if (remainingCycles > 1) {
                                    // Run the next 4-7-8 breathing cycle
    ...
    private void handleBreathingCyclesCompleted() {
        ...
        replayCardView.setCardBackgroundColor(ContextCompat.getColor(FourSevenEightExercise.this, R.color.mint_blue_green));
