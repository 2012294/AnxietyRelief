...
public class TriangleBreathingExercise extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_triangle_breathing_exercise);
        ...
        SharedPreferences sharedPreferences = this.getSharedPreferences("TriangleBreathingCounter", Context.MODE_PRIVATE);
        int counterValue = sharedPreferences.getInt("TriangleBreathingCounterValue", 2);
        ...
        HoldAudio = MediaPlayer.create(this, R.raw.hold_audio);
    ...
    private void startBreathingCycle(int currentCycle, int remainingCycles) {
        ...
        // Inhale phase (adjust the duration as needed)
        new CountDownTimer(4000, 1000) {
            ...
            @Override
            public void onFinish() {
                // Hold phase (same duration as inhale)
                HoldAudio.start();
                relaxationMessageTextView.setText("Hold");
                new CountDownTimer(4000, 1000) {
                    @Override
                    public void onTick(long millisUntilFinished) {
                        int secondsRemaining = (int) (millisUntilFinished / 1000);
                    ...
                    @Override
                    public void onFinish() {
                        // Exhale phase (same duration as inhale)
                        ...
                        new CountDownTimer(4000, 1000) {
                            ...
                            public void onFinish() {
                                ...
                                if (remainingCycles > 1) {
                                    // Run the next triangle breathing cycle
    ...
    private void handleBreathingCyclesCompleted() {
        ...
        replayCardView.setCardBackgroundColor(ContextCompat.getColor(TriangleBreathingExercise.this, R.color.mint_blue_green));
