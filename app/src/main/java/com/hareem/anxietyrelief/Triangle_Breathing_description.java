...
public class Triangle_Breathing_description extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_triangle_breathing_description);
        // BENEFITS section
...
//                SharedPreferences sharedPreferences = getSharedPreferences("TriangleBreathingCounter", Context.MODE_PRIVATE);
//                int triangleBreathingCounterValue = sharedPreferences.getInt("TriangleBreathingCounterValue", 2);
//
//                // Pass the value to the EqualBreathingExercise activity
//                Intent intent = new Intent(Triangle_Breathing_description.this, TriangleBreathingExercise.class);
//                intent.putExtra("triangle_breathing_counter_value", triangleBreathingCounterValue);
